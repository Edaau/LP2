...
public class Pessoa implements Serializable{
	...
	public static boolean isCodigoUser(String r2){
	...
	public static boolean isResposta3(String r1){
		for(int i = 0; i<r1.length();i++){
			if( !(Character.isDigit(r1.charAt(i))))
				return false;
		}
	...
	public static boolean isResposta4(String r1){
		for(int i = 0; i<r1.length();i++){
			if( !(Character.isDigit(r1.charAt(i))))
				return false;
		}
